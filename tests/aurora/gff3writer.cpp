...
GTEST_TEST(GFF3Writer, WriteSingleStruct) {
	...
	writer.getTopLevel()->addVector("FieldVector", 1.0f, 2.0f, 2.5f);
	writer.getTopLevel()->addOrientation("FieldOrientation", 1.0f, 4.0f, 2.5f, 1.5f);
...
GTEST_TEST(GFF3Writer, WriteEquivalentValues) {
	...
	writer.getTopLevel()->addVector("FieldVector_1", 0.0f, -13.5f, 42.75f);
	writer.getTopLevel()->addVector("FieldVector_2", 0.0f, -13.5f, 42.75f);

	writer.getTopLevel()->addOrientation("FieldOrient_1", 0.0f, -13.5f, 42.75f, 51.875f);
	writer.getTopLevel()->addOrientation("FieldOrient_2", 0.0f, -13.5f, 42.75f, 51.875f);
