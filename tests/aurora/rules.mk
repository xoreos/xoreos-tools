...
check_PROGRAMS                      += tests/aurora/test_bzfwriter
tests_aurora_test_bzfwriter_SOURCES  = tests/aurora/bzfwriter.cpp
tests_aurora_test_bzfwriter_LDADD    = $(aurora_LIBS)
tests_aurora_test_bzfwriter_CXXFLAGS = $(test_CXXFLAGS)
